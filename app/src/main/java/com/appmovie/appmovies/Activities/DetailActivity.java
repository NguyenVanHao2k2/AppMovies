...
import com.appmovie.appmovies.Adapters.ActionListAdapter;
import com.appmovie.appmovies.Adapters.CategoryAdapter;
import com.appmovie.appmovies.Adapters.CategoryEachFilmListAdapter;
import com.appmovie.appmovies.Domain.FilmItem;
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idFilm = getIntent().getIntExtra("id", 2);
        initView();
        sendRequest();
    ...
    private void sendRequest() {
        ...
        mStringRequest = new StringRequest(Request.Method.GET, "https://moviesapi.ir/api/v1/movies/" + idFilm, response -> {
            ...
            if (item.getImages() != null){
                adapterActorList = new ActionListAdapter(item.getImages());
